...
// Сколько максимум результатов отдаём в поиске по названию. Держим = пулу
// кандидатов (limit, по умолч. 200): отдаём все релевантные до 200, чтобы при
// листании поиска ничего нужного не терялось. Остатки/картинки догружаем для
// этого же набора уже ПОСЛЕ ранжирования (одним Promise.all). Категорий это не
