...
export const metadata: Metadata = {
  title: {
    default: `Автозапчасти в Екатеринбурге — купить с доставкой | ${siteName}`,
    template: `%s | ${siteName}`,
  },
  description:
    "Интернет-магазин автозапчастей BroCar в Екатеринбурге: 180 000+ товаров в наличии, подбор по VIN, оригинал и аналоги. Доставка по всей России!",
  keywords: [
