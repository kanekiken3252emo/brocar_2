...
const BRAND_CLUSTERS = {
  // Поставщики используют составное название бренда Calorstat by Vernet.
  // Схлопываем только эти однозначные варианты с VERNET. Одиночный
  // CALORSTAT оставляем отдельным брендом, чтобы не смешивать каталоги.
  vernetcalorstat: "VERNET",
  calorstatbyvernet: "VERNET",
};
