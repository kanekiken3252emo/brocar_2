...
const FAMILIES = [
  ...
  ["gm", "generalmotors", "opel", "chevrolet", "daewoo", "deawoo", "opelgm", "gmopel", "opelchevroletgm"],
  // Toyota/Lexus
  ...
  ["vag", "volkswagen", "vw", "audi", "skoda", "koda", "seat", "bentley", "vwaudi", "audivw", "vwvag", "vagvw", "vwaudiskodavag"],
  ...
  ["landrover", "rangerover", "jlr", "jaguarlandrover", "landroverrangerover"],
...
// ключ семейства.
// СОСТАВ семейств — буквально по списку владельца; ИМЕНА карточек — по
// принципу «Peugeot/Citroen/PSA»: перечисление брендов, чтобы покупатель
// Опеля/Ауди/Дачии узнал свою марку в имени карточки.
const FAMILY_NAMES = {
  psa: "Peugeot/Citroen/PSA",
  gm: "Opel/Chevrolet/GM",
  toyota: "Toyota/Lexus",
  hyundai: "Hyundai/Kia/Mobis",
  vag: "VW/Audi/Skoda/VAG",
  nissan: "Nissan/Infiniti",
  mercedes: "Mercedes",
  bmw: "BMW",
  renault: "Renault/Dacia",
