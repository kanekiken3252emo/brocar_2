 ...
 * Запрашиваем только сам артикул, без кроссов и характеристик: title, H1,
 * минимальная цена для SEO и актуальный порядок предложений должны совпадать
 * с живой карточкой, но метаданные не должны запускать тяжёлую загрузку аналогов.
 */
