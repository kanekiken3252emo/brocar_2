...
const nextConfig: NextConfig = {
  ...
  // Метаданные товарных карточек должны находиться в исходном <head>, а не
  // дописываться после служебных RSC-скриптов. SEO-снимок локальный, поэтому
  // блокирующее формирование metadata не вызывает запросов к поставщикам.
  htmlLimitedBots: /.*/,
  async headers() {
